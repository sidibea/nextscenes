...
?></div>
  ...
  <tr>
    <td width="27%"><div class="homeform">EMAIL</div></td>
    <td width="73%"> <input name="email" value="<?php if (isset($_POST['email'])) echo stripslashes(htmlentities(trim($_POST['email']))); ?>"  class="{validate:{required:true, email:true, messages:{required:&#39;* This field is required&#39;, email:&#39; * Enter a valid email&#39;}}}" type="text"></td>
  </tr>
...
-->
    ...
    <div align="center">
	<h5>Or Log In with your Facebook,Twitter & Google Account.</h5><br />
	
	
	<!--<a href="hybridauth/hybridauth/login-with.php?provider=Twitter"><img src='images/twitter.png'></img></a> <br><br>-->
	<a href="/google-login-api/"><img src='images/google.png'></img></a><br><br>
    
    <a href="facebook_login.php"><img src='images/facebook.png'></img></a> <br><br>
