...
<title>Super User || Search Result</title>
...
<?php
	...
	$limit =30;
	$tlink = $slug;
	$strings = mysql_real_escape_string($_REQUEST['s']);
	$tbname = "c_topics WHERE lower(topic) like \"%$strings%\" ORDER BY id DESC";
	$url = "";
