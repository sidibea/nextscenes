<?php $page = "storylines"; $subpage = "all"; require "functions.php"; isLoggedIn(); ?>
<!DOCTYPE html>
<html>
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Super User || My Storylines</title>
<?php include("include/head.php");?>
<div class="">
	<div class="col-md-2 col-sm-2 col-xs-12">
		<p class="nop nom"><a href="new_storyline.php">+ New Storyline</a></p>
	</div>
	...
	<table class="w100p table">
		...
		if(isset($_POST['search']) && ($_POST['search_text'] != "") && ($_POST['search_text'] != NULL)){
			$list = searchAllItems("mystoryline",$_POST['search_text'],"20",$_GET['sort'], $_GET['page']);
		}
		else{
			$list = getAllItems("mystoryline","20",$_GET['sort'], $_GET['page']);
		}
		if($_GET['page']){
			$i = (($_GET['page']*20)-20)+1;
		}
		...
		<tr class=\"maxxit\">
			...
			<span class=\"block mt10 _a\"><a href=\"edit_storyline.php?cat=".$key['sl_id']."\">Edit</a>";
			if($_SESSION['ev_u_auth'] == 1){
				echo " | <a href=\"delete_storyline.php?cat=".$key['sl_id']."\">Delete</a>";
			}
			echo "</span>
			</td>
