...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    {
        return $this->services['auth.provider.oauth'] = new \phpbb\auth\provider\oauth\oauth($this->get('dbal.conn'), $this->get('config'), $this->get('passwords.manager'), $this->get('request'), $this->get('user'), 'en_oauth_tokens', 'en_oauth_accounts', $this->get('auth.provider.oauth.service_collection'), 'en_users', $this, './', 'php');
    }
    ...
    {
        return $this->services['config'] = new \phpbb\config\db($this->get('dbal.conn'), $this->get('cache.driver'), 'en_config');
    }
    ...
    {
        return $this->services['config_text'] = new \phpbb\config\db_text($this->get('dbal.conn'), 'en_config_text');
    }
    ...
    {
        return $this->services['content.visibility'] = new \phpbb\content_visibility($this->get('auth'), $this->get('config'), $this->get('dispatcher'), $this->get('dbal.conn'), $this->get('user'), './', 'php', 'en_forums', 'en_posts', 'en_topics', 'en_users');
    }
    ...
    {
        $instance = new \phpbb\captcha\plugins\qa('en_captcha_questions', 'en_captcha_answers', 'en_qa_confirm');
    ...
    protected function getDbal_Conn_DriverService()
    {
        ...
        $instance->sql_connect('og21315-001.privatesql', 'nextscendiforums', 'hayTm2QV', 'nextscendiforums', '35357', false, false);
    ...
    {
        return $this->services['ext.manager'] = new \phpbb\extension\manager($this, $this->get('dbal.conn'), $this->get('config'), $this->get('filesystem'), $this->get('user'), 'en_ext', './', 'php', $this->get('cache.driver'));
    }
    ...
    {
        return $this->services['log'] = new \phpbb\log\log($this->get('dbal.conn'), $this->get('user'), $this->get('auth'), $this->get('dispatcher'), './', 'adm/', 'php', 'en_log');
    }
    ...
    {
        return $this->services['migrator'] = new \phpbb\db\migrator($this, $this->get('config'), $this->get('dbal.conn'), $this->get('dbal.tools'), 'en_migrations', './', 'php', 'en_', $this->get('migrator.tool_collection'), $this->get('migrator.helper'));
    }
    ...
    {
        return $this->services['migrator.tool.module'] = new \phpbb\db\migration\tool\module($this->get('dbal.conn'), $this->get('cache'), $this->get('user'), './', 'php', 'en_modules');
    }
    ...
    {
        return new \phpbb\notification\type\admin_activate_user($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './', 'php', 'en_notification_types', 'en_notifications', 'en_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\approve_post($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './', 'php', 'en_notification_types', 'en_notifications', 'en_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\approve_topic($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './', 'php', 'en_notification_types', 'en_notifications', 'en_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\bookmark($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './', 'php', 'en_notification_types', 'en_notifications', 'en_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\disapprove_post($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './', 'php', 'en_notification_types', 'en_notifications', 'en_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\disapprove_topic($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './', 'php', 'en_notification_types', 'en_notifications', 'en_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\group_request($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './', 'php', 'en_notification_types', 'en_notifications', 'en_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\group_request_approved($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './', 'php', 'en_notification_types', 'en_notifications', 'en_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\pm($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './', 'php', 'en_notification_types', 'en_notifications', 'en_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\post($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './', 'php', 'en_notification_types', 'en_notifications', 'en_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\post_in_queue($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './', 'php', 'en_notification_types', 'en_notifications', 'en_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\quote($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './', 'php', 'en_notification_types', 'en_notifications', 'en_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\report_pm($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './', 'php', 'en_notification_types', 'en_notifications', 'en_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\report_pm_closed($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './', 'php', 'en_notification_types', 'en_notifications', 'en_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\report_post($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './', 'php', 'en_notification_types', 'en_notifications', 'en_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\report_post_closed($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './', 'php', 'en_notification_types', 'en_notifications', 'en_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\topic($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './', 'php', 'en_notification_types', 'en_notifications', 'en_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\topic_in_queue($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './', 'php', 'en_notification_types', 'en_notifications', 'en_user_notifications');
    }
    ...
    {
        return $this->services['notification_manager'] = new \phpbb\notification\manager($this->get('notification.type_collection'), $this->get('notification.method_collection'), $this, $this->get('user_loader'), $this->get('config'), $this->get('dispatcher'), $this->get('dbal.conn'), $this->get('cache'), $this->get('user'), './', 'php', 'en_notification_types', 'en_notifications', 'en_user_notifications');
    }
    ...
    {
        return $this->services['profilefields.lang_helper'] = new \phpbb\profilefields\lang_helper($this->get('dbal.conn'), 'en_profile_fields_lang');
    }
    ...
    {
        return $this->services['profilefields.manager'] = new \phpbb\profilefields\manager($this->get('auth'), $this->get('dbal.conn'), $this->get('dispatcher'), $this->get('request'), $this->get('template'), $this->get('profilefields.type_collection'), $this->get('user'), 'en_profile_fields', 'en_profile_lang', 'en_profile_fields_data');
    }
    ...
    {
        return $this->services['user_loader'] = new \phpbb\user_loader($this->get('dbal.conn'), './', 'php', 'en_users');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            'core.root_path' => './',
            'core.php_ext' => 'php',
            'tables.auth_provider_oauth_token_storage' => 'en_oauth_tokens',
            'tables.auth_provider_oauth_account_assoc' => 'en_oauth_accounts',
            'tables.captcha_qa_questions' => 'en_captcha_questions',
            'tables.captcha_qa_answers' => 'en_captcha_answers',
            'tables.captcha_qa_confirm' => 'en_qa_confirm',
            'tables.config' => 'en_config',
            'tables.config_text' => 'en_config_text',
            'tables.ext' => 'en_ext',
            'tables.forums' => 'en_forums',
            'tables.log' => 'en_log',
            'tables.migrations' => 'en_migrations',
            'tables.modules' => 'en_modules',
            'tables.notification_types' => 'en_notification_types',
            'tables.notifications' => 'en_notifications',
            'tables.profile_fields' => 'en_profile_fields',
            'tables.profile_fields_data' => 'en_profile_fields_data',
            'tables.profile_fields_options_language' => 'en_profile_fields_lang',
            'tables.profile_fields_language' => 'en_profile_lang',
            'tables.posts' => 'en_posts',
            'tables.topics' => 'en_topics',
            'tables.user_notifications' => 'en_user_notifications',
            'tables.users' => 'en_users',
            ...
            'core.table_prefix' => 'en_',
            'cache.driver.class' => 'phpbb\\cache\\driver\\file',
            'dbal.driver.class' => 'phpbb\\db\\driver\\mysql',
            'dbal.dbhost' => 'og21315-001.privatesql',
            'dbal.dbuser' => 'nextscendiforums',
            'dbal.dbpasswd' => 'hayTm2QV',
            'dbal.dbname' => 'nextscendiforums',
            'dbal.dbport' => '35357',
            'dbal.new_link' => false,
        );
    }
