...
function msg_handler($errno, $msg_text, $errfile, $errline)
{
	...
	switch ($errno)
	{
		...
		case E_USER_ERROR:
			...
			echo '		Copyright &copy; Nextscenes.com  2015  -  All rights reserved  -<br>Powered by &reg; Forum Software &copy; phpBB Limited';
			echo '	</div>';
			echo '</div>';
			echo '</body>';
			echo '</html>';
...
function page_footer($run_cron = true, $display_template = true, $exit_handler = true)
{
	...
	*/
	...
	$template->assign_vars(array(
		...
		'CREDIT_LINE'			=> $user->lang('POWERED_BY', 'phpBB</a>&reg; Forum Software &copy; phpBB Limited'),
