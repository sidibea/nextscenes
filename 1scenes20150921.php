...
$query1 = 'SELECT COUNT(*) FROM rtgvote WHERE item = "'.mysql_clean($data2['id']).'" AND ( vote ="5" OR vote ="4" OR vote ="3" OR vote ="2" OR vote ="1") '; // AND scenes ="'.mysql_clean($sc).'"
$total1 = mysql_fetch_array(mysql_query($query1));

$query2 = 'SELECT COUNT(*) FROM rtgvote WHERE item = "'.mysql_clean($data2['id']).'" AND ( vote ="9" OR vote ="8" OR vote ="7" OR vote ="6") '; // AND scenes ="'.mysql_clean($sc).'"
...
$query4 = 'SELECT COUNT(*) FROM rtgvote WHERE item = "'.mysql_clean($data2['id']).'" AND vote ="4" '; // AND scenes ="'.mysql_clean($sc).'"
$total4 = mysql_fetch_array(mysql_query($query4));

$query5 = 'SELECT COUNT(*) FROM rtgvote WHERE item = "'.mysql_clean($data2['id']).'" AND vote ="5" '; // AND scenes ="'.mysql_clean($sc).'"
