...
'.ucfirst(html_entity_decode(coupechaine($data3['Text'], 300))).'
...
echo'
 <li class="slide">
  <div class="quoteContainer">
          <p class="quote-phrase"><span class="quote-marks">"</span> 
'.ucfirst(html_entity_decode(coupechaine($data2['Text'], 300))).'
...
echo' '.ucfirst(html_entity_decode(coupechaine($data2['Text'], 100))).'';
}
