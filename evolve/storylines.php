<?php $page = "storylines"; $subpage = "all"; require "functions.php"; ?>
<?php isLoggedIn(); ?>
<?php isAdmin(); ?>
...
<div class="main">
    ...
    <div class="content">
        ...
        <div class="plr10 bbvg pb10">
        	<div class="">
            	<div class="left">
                	<p class="nop nom"><a href="new_storyline.php">+ Add new storyline</a></p>
                </div>
                <div class="right">
                ...
                <div class="right">
                    ...
                    <?php 
						if($_POST['search_text']){
							$count = searchIt("storyline", $_POST['search_text']);
						}
						else{
		...
		?>
        	<table class="w100p table">
				...
				if(isset($_POST['search']) && ($_POST['search_text'] != "") && ($_POST['search_text'] != NULL)){
					$list = searchAllItems("storyline",$_POST['search_text'],"20",$_GET['sort'], $_GET['page']);
				}
				else{
				...
				<tr class=\"maxxit\">
					<td>".$i."</td>
					<td><a href=\"edit_storyline.php?cat=".$key['sl_id']."\">".utf8_encode(stripslashes($key['sl_name']))."</a>
					<span class=\"block mt10 _a\"><a href=\"approve.php?cat=".$key['sl_id']."\">Approve</a> | <a href=\"edit_storyline.php?cat=".$key['sl_id']."\">Edit</a> | <a href=\"delete_storyline.php?cat=".$key['sl_id']."\">Delete</a></span>
					</td>
					<td>".strip_tags(utf8_encode($key['sl_desc']))."</td>
					<td><a href=\"\">".strip_tags(utf8_encode($key['u_username']))."</a></td>
					<td>";
