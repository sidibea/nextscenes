<?php $page = "forums"; $subpage = "all"; require "functions.php"; ?>
<?php isLoggedIn(); ?>
...
<div class="main">
    ...
    <div class="content">
        ...
        <div class="plr10 bbvg pb10">
        	<div class="">
            	<div class="left">
                	<p class="nop nom"><a href="new_forum.php">+ Add new forum</a></p>
                </div>
                <div class="right">
                ...
                <div class="right">
                    ...
                    <?php 
						if($_POST['search_text']){
							$count = searchIt("forum", $_POST['search_text']);
						}
						else{
							$count = countIt("forum");
						}
		...
		?>
        	<table class="w100p table">
				...
				if(isset($_POST['search']) && ($_POST['search_text'] != "") && ($_POST['search_text'] != NULL)){
					$list = searchAllItems("forum",$_POST['search_text'],"20",$_GET['sort'], $_GET['page']);
				}
				else{
				...
				<tr class=\"maxxit\">
					<td>".$i."</td>
					<td><a href=\"edit_forum.php?cat=".$key['f_id']."\">".utf8_encode(stripslashes($key['f_name']))."</a>
					<span class=\"block mt10 _a\"><a href=\"edit_forum.php?cat=".$key['f_id']."\">Edit</a> | <a href=\"delete_forum.php?cat=".$key['f_id']."\">Delete</a></span>
					</td>
