...
<?php include("head.php");?>
	<div class="herald-section container">
		<div class="row">
        	...
        	<div class="pr20">
            	<ul class="twins">
                	<li><a href="manage-account-avatar">Change your avatar</a></li>
                	<li><a href="manage-account-user">Manage profile</a></li>
                	<li><a href="manage-account-pass">Manage your password</a></li>
                	<li><a href="account-activities">Account Activities</a></li>
                </ul>
