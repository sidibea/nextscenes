			...
			<div class="row">
                ...
                <div class=\"w100p courrier relative this_is_the_text\">
                    <fieldset class=\"relative\">
                        ...
                        echo utf8_encode($scene['vs_desc'])."
						<div class=\"avatar_holder mt10 right\">
							<div class=\"avatar_holder_main\">
								<div class=\"c_avatar ".$imgstylex."\">
									".$avatar."
					...
					$count++;
						...
						if(empty($_SESSION['idsession'])){
							...
							if($story_o['storylines']=='0'){ 
								...
								$the_url = '<a href="/'.custom_site_base().'readscene-'.urlThis($proposed_o['sl_name']).'-'.$proposed_o['sl_id'].'-'.$proposed_o['ps_id'].'" class="clickthis multi" rel="'.$proposed_o['ps_id'].'">&rarr; Read scene</a>';
							}
						}
				...
				<div class=\"w100p txtcenter\">
					<a href=\"write-".$story['sl_id']."\" class=\"clickthis multi block\">&rarr; Propose your scene</a></div>";
				}?></div>
				</div>
			<?php echo side2();?>
		</div>
