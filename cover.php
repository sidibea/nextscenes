	...
	<div class="herald-section container ">
		<div class="row">
			...
			<div class="row">
            	...
            	<fieldset>
					<legend>Create Book Cover</legend>
					<form action="mint?action=cover" method="post" class="e-form">
						<label for="bookTitle">Book Title</label>
						<input type="text" name="title" />
						<label for="author">Name Of Author</label>
						<input type="text" name="written" />
						<label for="desc">About Author</label>
						<textarea name="desc"></textarea>
						<label for="pattern">Select Book Cover Pattern</label>
						...
						<div align="center"><input type="submit" value="Proceed" class="btn btn-success" /></div>
					</form>
				</fieldset>
			</div>
			</div>
