		...
		<div class="herald-section container herald-no-sid">
			...
			<div class='movie_choice'>
						...
						<div id="r1" class="rate_widget">
							...
							<input type="hidden" class="rscene" value="26" />
							<input type="hidden" class="usrID" value="84" />
				...
				<div class="carousel slide" id="myCarousel" data-ride="carousel">
					...
					<div class="item active">
						...
						<div class="carousel-caption">
							...
							<p>Fictional storyline that should be full of dire, despirate situations and events</p>
						</div>
					</div>
					<div class="item">
						...
						<div class="carousel-caption">
							...
							<p>These storylines are fictional situations involving a crime such as murder, robbery, kidnapping, etc</p>
						</div>
					</div>
					<div class="item">
						...
						<div class="carousel-caption">
							...
							<p>In Mystery storyline, the contributors would try to suggest solutions to a mysterious event.</p>
						</div>
					</div>
					<div class="item">
						...
						<div class="carousel-caption">
							...
							<p class="cc">A storyline comprising of funny characters, comical events and situations. Comedies should...</p>
						</div>
					</div>
					<div class="item">
						...
						<div class="carousel-caption">
							...
							<p>Action storylines that should be full of dire, despirate situations and events. The cha...</p>
						</div>
					</div>
					<div class="item">
						...
						<div class="carousel-caption">
							...
							<p>Work of fiction that describes fictional people, events and places. The characters must ha...</p>
						</div>
					</div>
					<div class="item">
						...
						<div class="carousel-caption">
							...
							<p>These are storylines designed to amuse, entertain and teach the young ones. Stories should...</p>
						</div>
					</div>
					<div class="item">
						...
						<div class="carousel-caption">
							...
							<p>For historical storylines, contributors will try to rewrite history! Storylines may start ...</p>
						</div>
					</div>
					<div class="item">
						...
						<div class="carousel-caption">
							...
							<p class="hh">Horror storylines will be based on imaginary people, beings, events, locations, situations...</p>
						</div>
					</div>
					<div class="item">
						...
						<div class="carousel-caption">
							...
							<p>Stories that touch the heart. True to life experiences of ordinary people demonstrating an...</p>
						</div>
					</div>
					<div class="item">
						...
						<div class="carousel-caption">
							...
							<p>The thriller storylines are meant to keep the audience in suspense by creating fear mixed ...</p>
						</div>
					</div>
					</div>
	...
	<div class="col-lg-4 col-xs-3 col-sm-4">
		...
		<div class="col-lg-8 col-xs-9 col-sm-8 herald-no-pad">
			<div class="entry-header">
				...
				<span class="meta-category meta-small sc"><?php echo $story_m['u_username']; ?></span>
			</div>
		</div>
	</div>
	</article>
