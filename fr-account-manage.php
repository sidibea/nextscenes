...
$erreur = '<font color=#ff0000><b>Modif OK.</b></font>'; 
} 
?>
...
<body>
	...
	<div class="inner-banner">
		<div class="note"><strong>Mon Compte</strong>  -  <?php
	  
 if (isset($erreur)) echo '',$erreur;
?>    <?php include 'fr-account-manage-menu.php' ; ?></div>
	    <div class="clear"></div>
	</div>
	</div>
	...
	<div class="wrapper dark">
        ...
        <div class="note"><strong>Profile </strong></div> 
	  ...
	  <div class="msg-form column8">
        ...
        <div class="headings">
         <blockquote>
          ...
          <div class="profile">LOGIN</div> <h5 class="hprofile"><?php echo $data0['Login'] ; ?></h5>
               <div class="profile">LAST NAME</div><h5 class="hprofile"><?php echo $data0['LastName'] ; ?></h5>
             
					<div class="profile">FIRST NAME</div><h5 class="hprofile"><?php echo $data0['FirstName'] ; ?></h5>
                    
					<div class="profile">EMAIL</div> <h5 class="hprofile"><?php echo $data0['Email'] ; ?></h5>
           ...
           <div class="note"><strong>My Profile </strong></div> 
          <div class="headings">
         <blockquote>
         
          <div class="profile">ACCOUNT</div> <h5 class="hprofile"><?php echo $data0['Account'] ; ?> User &nbsp;&nbsp; [<a href="account-manage-user.php"> Change Account </a> ]
          <br /> <br />
          
 <?php  if ($dataUser['Account'] == 'Power') { echo ' <strong>You can Write in all forum</strong>' ; } ?>
 <?php  if ($dataUser['Account'] == 'Regular') { echo ' <strong>You can not Write in all forum</strong> ' ; } ?> 
           ...
           <div class="note"><strong>My Password </strong></div> 
          <div class="headings">
         <blockquote>
         
          <div class="profile">PASSWORD</div> <h5 class="hprofile"> ******  &nbsp;&nbsp; [ <a href="password.html"> Change Password </a> ]</h5>
