			...
			$password == "" || $password == NULL){
				...
				if($this->num_rows($result) == 0){
					...
					if($this->num_rows($result2) > 0){
						...
						$insr = "INSERT INTO c_users (u_email,u_pass,u_username,c_usertypes_ut_id,u_avatar, u_fname, u_lastname, c_languages_l_id) 
							VALUES
							(\"$email\", \"$password\"   , \"$username\", 2, 'avatars/default.png', \"$firstname\", \"$lastname\", 2)"; 
