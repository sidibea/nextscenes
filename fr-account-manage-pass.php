...
$sql='UPDATE members SET Password="'.mysql_clean(@$_POST['password']).'" WHERE Idsession="'.mysql_clean($_SESSION['idsession']).'" AND Login ="'.mysql_clean($_SESSION['login']).'" ';mysql_query($sql) or die('Erreur SQL !'.$sql.'<br />'.mysql_error());
...
<body>
	...
	<div class="inner-banner">
		<div class="note"><strong>My Account</strong>  -  <?php
...
?>    <?php include 'fr-account-manage-menu.php' ; ?></div>
	...
	<div class="wrapper dark">
		...
		<div class="main-blog column9">
         <div class="note"><strong>Manage your Password </strong> <?php
...
?></div>
       <div class="contact-row dark">
        ...
        <div class="headings">
         <blockquote>
          ...
          <div class="profile">YOUR PASSWORD</div> 
          <h5 class="hprofile">
	  ...
	  <div class="msg-form column8">
        <form  class="formular" name="captchaform" id="captchaform" method="post" action="">
           	 ...
           	 <legend><strong>Change your Password</strong></legend>
                
              
                <div class="homeform">NEW PASSWORD</div> <input name="password" value="<?php if (isset($_POST['password'])) echo stripslashes(htmlentities(trim($_POST['password']))); ?>" class="{validate:{required:true, nowhitespace:true, messages:{required:&#39;* This field is required&#39;, minlength:&#39; * Entrer 6 caracteres minimum&#39;}}}" minlength="6" id="password" type="password" >

<div class="homeform">REPEAT NEW PASSWORD</div> <input name="confirm_password" value="<?php if (isset($_POST['confirm_password'])) echo stripslashes(htmlentities(trim($_POST['confirm_password']))); ?>" id="confirm_password" type="password">
