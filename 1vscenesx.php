	...
	<div class="main ptb20">
    	<div class="main_left">
        	<div class="pr20">
				...
				echo "
				<div class=\"read_proposed_posts clear\"></div>
					...
					foreach($proposed as $proposed_o){
						...
						if(empty($_SESSION['idsession'])){
							...
							if($story_o['storylines']=='0'){ 
								...
								$the_url = '<a href="scenes-'.$proposed_o['id'].'-'.reecUrl($proposed_o['Title']).'-'.$proposed_o['idstory'].'.html" class="clickthis multi click_to_read_this" rel="'.$proposed_o['id'].'">&rarr;';
								if(!isset($_SESSION['language_session']) || ($_SESSION['language_session'] == "en")){
									$the_url .= "Read scene";
								}
								else{
