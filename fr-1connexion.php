...
// redirect_to($referer);
			...
			elseif ($data0[0] == 0) { 
         $erreur = '<font color=#ff0000><b>Erreur sur votre Login ou votre Mot de passe !</b></font>';
      } 
...
<body>
	...
	<div class="inner-banner">
		...
		<div class="site-map">
    	Vous êtes ici  :<a href="index.html">Home</a> &gt; Connexion
		</div>
	<div class="clear"></div>
	</div>
	</div>
	...
	<div class="wrapper dark">
		...
		<div class="main-blog column9">
         ...
         <img src="/images/ns728x90.jpg" width="728" height="90" alt="">
      ...
      <div class="scenes">
       <fieldset>
            	<legend>Entrez vos paramètres de connexion : Login et Password</legend>
        <div class="search">
				<p>  <?php
