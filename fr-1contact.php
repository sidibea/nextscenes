...
<title>NextScenes : Contactez-nous</title>
...
<body>
	...
	<div class="inner-banner">
		<div class="note">Pour toutes demandes de renseignements concernant ce site Web et le contenu, veuillez nous contacter à l'adresse ci-dessous.</div>
		<div class="site-map">
    	Vous êtes ici : <a href="index.php">Home</a> &gt; Contactez-nous
		</div>
	<div class="clear"></div>
	</div>
	</div>
...
Bamako, Mali.
	...
	+223 7015 9015
			...
			<div class="msg-form column8">
				<h4>Envoyez nous un message en remplissant ce formulaire</h4>
				<div class="border"></div>
				<form id="formulairecontact" action="" method="post" enctype="multipart/form-data">
                <p class="error"></p>
					<input  name="name" id="name" type="text" data-value="name" required="true" placeholder="nom"><br /><br />
