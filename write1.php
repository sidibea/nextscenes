...
<title>Nextscenes.com - <?php if(!isset($_SESSION['language']) || ($_SESSION['language'] == "en")){
								echo "Propose The Next Scene";
				
							}
							else{
								echo "Proposer la scène suivante";
							}?>
</title>
		...
		<div class="row">
			...
			<div class="row">					
				   <div class="herald-module col-lg-12 col-md-12 col-sm-12" id="herald-module-3-0" data-col="12">
						<div class="herald-mod-wrap">
							<div class="herald-mod-head herald-cat-2">
								<div class="herald-mod-title"><h2 class="h6 herald-mod-h herald-color"><?php if(!isset($_SESSION['language']) || ($_SESSION['language'] == "en")){
								echo "Propose The Next Scene";
				...
				<div class=\"w100p\" id=\"write_your_own_scene\">
					...
					<form method=\"post\" action=\"/".custom_site_base()."write1-".$id."#write_your_own_scene\">
				...
				<div class=\"w100p\" id=\"write_your_own_scene\">
					<h3 class=\"h3 clear pt20 pb10\">".$mmsg."</h3>
					<form method=\"post\" action=\"/".custom_site_base()."write1-".$id."#write_your_own_scene\">
						<textarea id=\"nextscenes\"  onKeyUp=\"textCount(this)\" onKeyDown=\"textCount(this)\" name=\"nextscenes\" placeholder=\"Cliquez pour écrire...\"></textarea>
						<!-- <p id=\"mon_compteur\">0 words/500</p> -->
						<span id=\"countdata\"></span>
						<input type=\"submit\" name=\"submit\" id=\"submit\" value=\"Soumettre\" class=\"c_btn mt10\">
					</form>
				</div>";
			}
                ...
                <div class=\"w100p courrier relative this_is_the_text\">
                	...
                	<div class=\"c_1mm\"></div>
                    <fieldset class=\"relative\">
                        <legend>Dernière scène validée</legend>";
						$imgstylex = getImgStyle("avatars/".$scenes['u_avatar']);
						if(!empty($scenes['avatar'])){
							$avatar = "<img src=\"avatars/".$scenes['u_avatar']."\"/>";
						}
