...
if(!empty($titrefr) && !empty($textefr))
{
...
if(!empty($fichier))
{
	...
	$sql="UPDATE $t3 SET Titlefr='$titrefr', Descriptionsfr='$textefr', filename='$fichier' WHERE Iddata='$op1'";
	...
	echo'<script language="javascript">
        ...
        {
			$sql="UPDATE $t3 SET Titlefr='$titrefr', Descriptionsfr='$textefr' WHERE Iddata='$op1'";
	mysql_query($sql) or die('Erreur SQL !'.$sql.'<br />'.mysql_error());
	redirect_to('../home.php');
