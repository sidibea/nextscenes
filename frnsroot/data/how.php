...
<body class="withvernav">
    ...
    <div class="centercontent">
        ...
        <div class="pageheader">
            <h1 class="pagetitle"><?php echo $info['Titlefr']; ?></h1>
           
            
            <ul class="hornav">
               
                <li class="current"><a href="#"><?php echo $info['Titlefr']; ?></a></li>
            </ul>
        </div><!--pageheader-->
        ...
        <div id="contentwrapper" class="contentwrapper">
        	...
        	<div id="default" class="subcontent">
                  ...
                  <input name="op1" type="hidden" id="op1" value="2">
                        		...
                        		<label>Titre</label>
                            <span class="field"><input type="text" name="titrefr" value="<?php echo $info['Titlefr']; ?>" class="smallinput"></span>
...
$oFCKeditor->Value = ''.$info['Descriptionsfr'].'';
