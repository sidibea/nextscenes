                        ...
                        <table cellpadding="0" cellspacing="0" border="0" class="stdtable overviewtable">
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th class="head0">Proposed Scenes</th>
                                    <th class="head1">Validated Scenes</th>
                            ...
                            <tbody>
                                <tr>
                                    <td><?php 
									$query = 'SELECT COUNT(*) as id FROM forums WHERE lang="fr" ';
									$total = mysql_fetch_array(mysql_query($query));
									echo $total['id'] ;
									?></td>
                                    <td><?php 
									$query = 'SELECT COUNT(*) as id  FROM scenes_proposes  WHERE lang="fr"';
									$total = mysql_fetch_array(mysql_query($query));
									echo $total['id'] ;
									?></td>
                                    <td class="center">
                                    <?php 
									$query = 'SELECT COUNT(*) FROM scenes_valides  WHERE lang="fr"';
									$total = mysql_fetch_array(mysql_query($query));
									echo $total[0] ;
									?>
                                    </td>
                                    <td class="center"><?php 
									$query = 'SELECT COUNT(*) FROM members  WHERE lang="fr"';
									$total = mysql_fetch_array(mysql_query($query));
									echo $total[0] ;
									?></td>
                                </tr>
