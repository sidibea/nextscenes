...
<body class="withvernav">
    ...
    <div class="centercontent">
        ...
        <div class="pageheader">
            ...
            <h1 class="pagetitle">Administration des Histoires ou Story Lines</h1>
            
            <ul class="hornav">
              
                <li class="current"><a href="manage.php">Gerer les Story Lines </a></li>
                  <li class=""><a href="insert.php">Créer une Story Line</a></li>
