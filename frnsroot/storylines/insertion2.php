...
$sql='INSERT INTO storylines (DateCreate,IdForum, Forum, Title,Description,Login,Filename,lang) VALUES ("'.$date.'", "'.$IdFor.'", "'.$dataforum['Title'].'", "'.$title.'", "'.$texte.'","'.$login.'","'.$fichier.'","fr")'; // ,"'.time().'"
