...
$sql4 = 'SELECT * FROM scenes_valides WHERE idstory = "'.mysql_clean($id).'" AND scenes="2" ORDER BY id DESC LIMIT 1';
...
<body>
	...
	<div class="inner-banner">
		...
		<div class="site-map">
    	Vous êtes  : <a href="index.html">Home</a> &gt; <a href="forums.html">Forums</a> &gt; <a href="storylines-<?php echo reecUrl($data1['Forum']) ; ?>-<?php echo $data1['IdForum'] ; ?>.html"> Story Lines <?php echo $data1['Forum'] ; ?></a> &gt; <strong>Lecture des Scènes</strong>
		</div>
	<div class="clear"></div>
	</div>
	</div>
...
*/
	   ?>
             ...
             <?php echo'<br><div class=post-user><strong> '.$data4['Date'].' - Proposée par '.$data4['Login'].' </strong> </div> '; ?>
             </blockquote>
...
-->
 ...
 <?php  if ($dataUser['Account'] == 'Regular') { echo '<div align=center><div class="blog-text2"><a href="user.html">Change your Profile to propose Scenes</a></div></div> ' ; } ?>
 <br />
