...
<title>NextScenes : <?php echo $info['Title'] ;  ?></title>
<?php include'css.php'; ?>
...
<body>
	...
	<div class="inner-banner">
		<div class="note"><?php echo $info['Title'] ;  ?> NextScenes:  - The next level in literary entertainment. Unleash your imagination, get challenged!</div>
		<div class="site-map">
    	You are here :<a href="index.php">Home</a> &gt; <?php echo $info['Title'] ;  ?>
		</div>
	<div class="clear"></div>
	</div>
	</div>
