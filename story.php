		...
		<div class="row">
			...
			<div class="row">
				...
				<fieldset id="commentbox">
					<legend>Write Or Request Your NextScene</legend>
				...
				<?php if($row['edit'] == 1){?>
				<fieldset id="commentbox">
					<legend>Contributions For The NextScene</legend>
					<div class="my-slider">
						<ul>
							<li>
				...
				<fieldset id="commentbox">
					<legend>Write Your Contribution Below</legend>
					<?php required(); failed(); success(); length();?>
					<form action="mint.php?action=newcontribution" method="post" class="e-form">
						<div class="c_label">Write Your Contribution Here:</div>
						<div style="height:5px;"></div>
				...
				<?php }?>
				<fieldset>
					<legend>Share With Your Friends By Clicking On The Share Buttons</legend>
						<div id="fb-root"></div>
					  ...
					  <script type="text/javascript">var switchTo5x=true;</script>
						...
						<div class="fb-comments"  data-href="<?php echo "http://www.nextscenes.com/story-".$slug;?>" data-width="740" data-numposts="5"></div>
				</fieldset>
			</div>
			</div>
			<?php echo side2();?>
