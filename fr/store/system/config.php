...
define('SERVER_NAME', 'nextscenes.com');
// Admin Section Configuration. You can change this value to any name. Will use ?s=name to access the admin
define('ADMIN_PATH', 'nsfrstore');

// Database Configuration
define('DB_DRIVER', 'mysql');
define('DB_HOSTNAME', 'og21315-001.privatesql:35357');
define('DB_USERNAME', 'nextscendifrstor');
define('DB_PASSWORD', 'Nextscenes2');
define('DB_DATABASE', 'nextscendifrstor');
define('DB_PREFIX', 'abc_');

define('CACHE_DRIVER', 'file');
// Unique AbanteCart store ID
define('UNIQUE_ID', '9ed541726aa96b20782e0829af44b842');
