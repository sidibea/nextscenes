...
$op1=$_GET['op1'];
$sql='select * from '.$t2.' where idnews = '.$op1.'';
$req=mysql_query($sql);
...
$sql1= 'SELECT*FROM '.$t2.'  WHERE idnews="'.$op1.'"' ; 
...
<!--<script src="dedicaces2.js" type="text/javascript" language="javascript"></script>
        ...
        <div id="squeeze">
          <div id="content">
            ...
            <div id="mainTabs" >
              ...
              <!-- ****************** MAIN TABS MENU ****************** -->
              <ul id="mainTabsMenu">
			  <li><a href="#mainTab-1" onclick="this.blur();"><strong>ACTUALITE -MODIFICATION</strong></a></li>
            ...
            <tr>
              ...
              <form action="modif2.php" method="post" enctype="multipart/form-data" name="formu">
	<input name="op1" type="hidden" id="op1" value="<?php echo $result['idnews']; ?>">
  <table width="95%" border="0" align="center" cellpadding="3" cellspacing="3" bgcolor="#FFFFFF">
    
    <tr>
      <td><div align="right">Rubrique </div></td>
      <td><select name="rub" id="select2" >
        <option value="<?php echo $result['rub']; ?>" selected><?php echo $result['rub']; ?></option>
      ...
      <option value="afrik">Afrique</option>
       <option value="apo">APO</option>
        <option value="spo">Sport</option>
		 ...
		 <option value="nat" >Nationale</option>
      <option value="int">Internationale</option>
      <option value="dos">Dossiers</option>
		<option value="efo" >Echo & Formations </option>-->	
    ...
    <tr>
      ...
      <td><select name="position" id="position" >
        <option value="<?php echo $result['position']; ?>" selected="selected"><?php echo $result['position']; ?></option>                  
    ...
    <tr>
      ...
      <td><input type="text" size="160" name="loc" value="<?php echo $result['loc']; ?>" /></td>
      </tr>
      
    <tr>
      <td width="12%"><div align="right">Titre</div></td>
      <td width="88%"><textarea cols="120" rows="2" name="titre"><?php echo html_entity_decode(trim($result['titre'])); ?></textarea></td>
      </tr>
	<tr>
      <td width="12%"><div align="right">Titre</div></td>
      <td width="88%"><textarea cols="120" rows="2" name="titre2"><?php echo html_entity_decode(trim($result['titre2'])); ?></textarea></td>
      </tr>
      
      
      <tr>
      <td><div align="right">Lien http://</div></td>
      <td><input type="text" size="70"  value="<?php echo $result['lien']; ?>" name="lien" />
        <strong>* OBLIGATOIRE POUR AUTRE MEDIA</strong></td>
    </tr>
    <tr>
      <td><div align="right">Target</div></td>
      <td><select name="target" id="target" >
        <option value="<?php echo $result['target']; ?>" selected><?php echo $result['target']; ?></option>
...
<option value="" selected="selected">---</option>
    ...
    <tr>
      <td><div align="right">Source</div></td>
      <td><input type="text" size="50"  value="<?php echo $result['source']; ?>" name="source2" /></td>
      </tr>
    ...
    <tr>
      ...
      <td>
	  <input type="text" name="date_actu" value="<?php echo $Date ?>" readonly="readonly"/>
