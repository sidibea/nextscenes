...
include'../../includes/connect_db.php';
		...
		$fields = array("IdScenes" => "Id", "DateCreate" => "Date", "Forums" => "Forums", "Title" => "Title Scenes",  );
...
*/
             echo "<td align=left width=100> $result[IdScenes] </td>"; // <a href=\"stocks_insert.php?op=$result[IdProduit]\">
             echo "<td align=left width=90> $result[DateCreate] </td>"; //  </a>
		
			 echo "<td align=left width=120> $result[Forums] </td>";
			 
			
			// echo "<td align=left> <img src=../../pictures/$result[Filename] width=25 height=25> </td>";
			  echo "<td align=left>
			         <a href=\"supp.php?op=$result[IdScenes]\"><img src=../image/supp.png border=0 width=16 height=16></a> - 
					 <a href=\"modif.php?op1=$result[IdScenes]\">$result[Title]</a>  
