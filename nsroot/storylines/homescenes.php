...
$scenes_suiv= ''.$data0["scenes"].'' +1;
									
echo'
<tr>
                            <td>Scene '.$data0["scenes"].'</td>
                            <td>'.$total[0].' proposed scenes for scenes '.$scenes_suiv.' - <a href=scenes.php?idstory='.mysql_clean($id).'&sc='.$data0["scenes"].'><strong>View</strong></a></td>
