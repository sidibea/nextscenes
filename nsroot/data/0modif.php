...
if(!empty($fichier))
{
	...
	$sql="UPDATE $t3 SET Title='$titre', Titlefr='$titrefr', Descriptions='$texte', Descriptionsfr='$textefr', filename='$fichier' WHERE Iddata='$op1'";
	...
	echo'<script language="javascript">
        ...
        {
			$sql="UPDATE $t3 SET Title='$titre', Titlefr='$titrefr', Descriptions='$texte', Descriptionsfr='$textefr' WHERE Iddata='$op1'";
	mysql_query($sql) or die('Erreur SQL !'.$sql.'<br />'.mysql_error());
	redirect_to('../home.php');
