...
$op1=$_GET['op1'];
$sql='select * from '.$t3.' where IdForums = '.$op1.'';
$req=mysql_query($sql);
$result=mysql_fetch_array($req);


$sql1= 'SELECT*FROM '.$t3.'  WHERE IdForums="'.$op1.'"' ; 
    ...
    <div class="centercontent">
        ...
        <div class="pageheader">
            ...
            <ul class="hornav">
                ...
                <li class="current"><a href="#">MODIFICATION FORUM</a></li>
            </ul>
        </div><!--pageheader-->
        ...
        <div id="contentwrapper" class="contentwrapper">
        	...
        	<div id="default" class="subcontent">
                  ...
                  <input name="op1" type="hidden" id="op1" value="<?php echo $result['IdForums']; ?>">
