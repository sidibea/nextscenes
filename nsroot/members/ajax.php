...
include'../../includes/connect_db.php';
		...
		$fields = array("Date" => "Registration Date", "Login" => "Login", "Account" => "Type Account" , "Nscenes" => "Next Scenes"  );
...
*/
            // echo "<td align=left width=100> $result[IdMembers] </td>"; // <a href=\"stocks_insert.php?op=$result[IdProduit]\">
             echo "<td align=left width=100> $result[Date] </td>"; //  </a>
		
			 echo "<td align=left width=120> $result[Login] </td>";
			 
			
			// echo "<td align=left> <img src=../../pictures/$result[Filename] width=25 height=25> </td>";
			  echo "<td align=left width=120>$result[Account] </td>"; 
			  
			    echo "<td align=left width=120>$result[Nscenes] </td>"; 
					 // ".CoupeChaine($result[titre], 50)." <a href=\"stocks_insert.php?op=$result[IdProduit]\"> </a>
...
<tfoot>
	<tr><td colspan="30"><h2><?php echo $rowCount . " Members "; ?></h2></td></tr>
</tfoot>
</table>
</div>
