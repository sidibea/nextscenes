...
//$t2 = "scenes";
		...
		$fields = array("IdScene" => "Id", "DateCreate" => "Date", "Forum" => "Forums", "Title" => "Title Scenes",  );
...
*/
             echo "<td align=left width=100> $result[IdScene] </td>"; // <a href=\"stocks_insert.php?op=$result[IdProduit]\">
			...
			// echo "<td align=left> <img src=../../pictures/$result[Filename] width=25 height=25> </td>";
			  echo "<td align=left>
			         <a href=\"supp.php?op=$result[IdScene]\"><img src=../image/supp.png border=0 width=16 height=16></a> - 
					 <a href=\"modif.php?op1=$result[IdScene]\">$result[Title]</a>  
