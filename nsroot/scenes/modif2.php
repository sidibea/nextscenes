...
if(!empty($fichier))
{
	...
	$sql="UPDATE $t2 SET Title='$title', IdForum='$IdFor', Forum='$dataforum1', Description='$texte', filename='$fichier' WHERE IdScene='$op1'";
	...
	echo'<script language="javascript">
        ...
        {
			$sql="UPDATE $t2 SET Title='$title', IdForum='$IdFor', Forum='$dataforum1', Description='$texte' WHERE IdScene='$op1'";
	mysql_query($sql) or die('Erreur SQL !'.$sql.'<br />'.mysql_error());
	redirect_to('manage.php');
