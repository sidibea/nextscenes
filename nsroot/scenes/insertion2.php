...
$sql='INSERT INTO scenes (DateCreate,IdForum, Forum, Title,Description,Filename) VALUES ("'.$date.'", "'.$IdFor.'", "'.$dataforum['Title'].'", "'.$title.'", "'.$texte.'","'.$fichier.'")'; // ,"'.time().'"
mysql_query($sql) or die('Erreur SQL !'.$sql.'<br />'.mysql_error());

$sql0 = 'UPDATE forums SET Scenes=Scenes+1 WHERE IdForum= "'.mysql_clean($IdFor).'"';
