...
$op1=$_GET['op1'];
$sql='select * from '.$t2.' where IdScenes = '.$op1.'';
$req=mysql_query($sql);
$result=mysql_fetch_array($req);


$sql1= 'SELECT*FROM '.$t2.'  WHERE IdScenes="'.$op1.'"' ; 
    ...
    <div class="centercontent">
        ...
        <div id="contentwrapper" class="contentwrapper">
        	...
        	<div id="default" class="subcontent">
                  ...
                  <input name="op1" type="hidden" id="op1" value="<?php echo $result['IdScenes']; ?>">
                    	<p>
                        	<label>Category</label>
                            
                          <select name="forums" id="select" >
    <option value="<?php echo $result['Forums']; ?>" selected><?php echo $result['Forums']; ?></option>	
     <?php
