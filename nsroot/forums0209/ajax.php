...
include'../../includes/connect_db.php';
		...
		$fields = array("IdForums" => "Id", "DateCreate" => "Date", "Title" => "Title", "Scenes" => "Scenes",  );
...
*/
             echo "<td align=left width=100> $result[IdForums] </td>"; // <a href=\"stocks_insert.php?op=$result[IdProduit]\">
			...
			// echo "<td align=left> <img src=../../pictures/$result[Filename] width=25 height=25> </td>";
			  echo "<td align=left>
			         <a href=\"supp.php?op=$result[IdForums]\"><img src=../image/supp.png border=0 width=16 height=16></a> - 
					 <a href=\"modif.php?op1=$result[IdForums]\">$result[Title]</a>  
					 </td>"; // ".CoupeChaine($result[titre], 50)." <a href=\"stocks_insert.php?op=$result[IdProduit]\"> </a>
