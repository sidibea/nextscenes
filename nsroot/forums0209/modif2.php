...
if(!empty($fichier))
{
	...
	$sql="UPDATE $t3 SET Title='$titre', Descriptions='$texte', filename='$fichier' WHERE IdForums='$op1'";
	...
	echo'<script language="javascript">
        ...
        {
			$sql="UPDATE $t3 SET Title='$titre', Descriptions='$texte' WHERE IdForums='$op1'";
	mysql_query($sql) or die('Erreur SQL !'.$sql.'<br />'.mysql_error());
	redirect_to('manage.php');
