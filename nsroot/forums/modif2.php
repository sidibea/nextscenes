...
if(!empty($fichier))
{
	...
	//$sql="UPDATE $t3 SET Title='$titre', Titlefr='$titrefr', Descriptions='$texte', Descriptionsfr='$textefr', filename='$fichier' WHERE IdForum='$op1'";
		$sql="UPDATE $t3 SET Title='$titre', Descriptions='$texte', filename='$fichier' WHERE IdForum='$op1'";
	...
	echo'<script language="javascript">
        ...
        {
			$sql="UPDATE $t3 SET Title='$titre', Descriptions='$texte' WHERE IdForum='$op1'";
	mysql_query($sql) or die('Erreur SQL !'.$sql.'<br />'.mysql_error());
	redirect_to('manage.php');
