...
<title>NextScenes : Divertissement littéraire - Français .</title>
...
<body>
	...
	<div class="slider" >
		<div class="flexslider">
		  <ul class="slides">
		    <li>
		      <img src="/images/slider-img.jpg" />		    </li>
             <li>
		      <img src="/images/slider-img1.jpg" />		    </li>
             <li>
		      <img src="/images/slider-img2.jpg" />		    </li>
		  </ul>
		</div>
...
<!-- End SLider -->
	...
	<div class="wrapper">
		...
		<div class="l-more">
			<div class="l-banner">
				<p><strong>NextScenes:</strong> Le prochain niveau en matière de divertissement littéraire. Libérez votre imagination!</p>
				<a href="principes.html">Lire</a>
				<div class="clear"></div>
			</div>
		</div>
...
$query1 = 'SELECT * FROM forums WHERE lang="fr"';		
...
echo '
 ...
 <div class="slide">
						...
						if(empty($data1['Filename']))  { echo '<img src="/pictures/avatar.jpg" alt="">'; } else { echo '<img src="/pictures/'.$data1['Filename'].'" />'; }
   ...
   { echo ' <a href="connect.html" class="info">Visitez ce forum</a>
   '; } // Se connecter
    else {  if($data1['storylines']=='0') // sinon id session n'est pas vide mais si la variable scene egale a 0
	{ echo ' <a href="#" class="info">Forum Inactif </a> '; } // Lien InActif
