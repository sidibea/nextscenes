...
<body>
	...
	<div class="inner-banner">
		<div class="note"><font color=#ff0000>Successful registration</font></div>
		<div class="site-map">
    	You are receive :<a href="index.html">Home</a> &gt; Registration
		</div>
	<div class="clear"></div>
    <i>You have received a welcome email in your account <font color=#ff0000><?php echo $_SESSION['email'] ; ?></font></i>
	</div>
	</div>
	...
	<div class="wrapper dark">
	  ...
	  <div class="msg-form column8">
       <fieldset>
            	<legend>Enter yours login and Password to connect</legend>
        <div class="search">
				<p>  <?php
...
$sql1 = 'SELECT * FROM members Order by IdMembers DESC limit 0,3';
$req1 = mysql_query($sql1) or die('Erreur SQL !<br />'.$sql1.'<br />'.mysql_error()); 
