...
<title>Nextscenes - Create New Story</title>
	...
	<div class="herald-section container ">
		<div class="row">
			...
			<div class="row">					
				   <div class="herald-module col-lg-12 col-md-12 col-sm-12" id="herald-module-3-0" data-col="12">
						<div class="herald-mod-wrap">
							<div class="herald-mod-head herald-cat-2">
								<div class="herald-mod-title"><h2 class="h6 herald-mod-h herald-color">Create New Story</h2></div>
							</div>
						</div>
				...
				<fieldset>
					<legend>New Story Content</legend>
					<div id="tellus">
						<?php required(); failed(); postExist(); length(); success();nmode();?>
					</div>
					<form action="mint.php?action=newpost" method="post" class="e-form">
						<div class="c_label">Select Visibility/Group Story Project</div>
						...
						<a class="c_btn mt10 savedraft" style="cursor:pointer;">Save To Draft</a> <span id="note"></span>
					</form>
				</fieldset>
				</div>
					</div>
